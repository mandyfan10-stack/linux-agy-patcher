...
- [dns-ai.ru](https://dns-ai.ru/) (Nova, тот же `t.me/nova_txt`): DoT на `dns.dns-ai.ru:853`. UDP/53 закрыт. Подменяет только CloudCode-имена на узел в NL.
...
| [dns-ai.ru](https://dns-ai.ru/) | DoT `dns.dns-ai.ru` (`186.246.49.127`, `217.60.10.20`) | DoT отдаёт `186.246.45.126` (NL). На 31 Aug 2026 TLS там ещё не открыт — HTTP-проба отсекает, остаётся geohide |
