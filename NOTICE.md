...
**[confeden/Antigravity](https://github.com/confeden/Antigravity)** (релизы вплоть до v2.9.1_29, 25 Aug 2026)
...
| [geohide.ru](https://dns.geohide.ru:8443/) | 45.155.204.190, 37.230.192.51 | прокси `95.182.120.241` / `45.155.204.190` / `37.230.192.51` |
...
- Локальный CONNECT-прокси с failover по трём IP geohide.
